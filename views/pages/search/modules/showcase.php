...
<div id="showcase" class="ps-shopping ps-tab-root preloadFalse">
    ...
    <div class="ps-shopping__header">
        ...
        <p><strong> <?php echo $totalSearch ?></strong> Productos encontrados</p>
            ...
            <select class="select2" data-placeholder="Sort Items" onchange="sortProduct(event)">
                ...
                <?php if (isset($urlParams[2])): ?>
                    ...
                    <?php if ($urlParams[2] == "new"): ?>
                        ...
                        <option value="<?php echo $_SERVER["REQUEST_URI"] ?>+new">Ordenar por novedad</option>
                        <option value="<?php echo $_SERVER["REQUEST_URI"] ?>+latest">Ordenar por el más reciente</option>
                        ...
                        <div class="ps-product">
                            ...
                            <div class="ps-product__thumbnail">
                                ...
                                <ul class="ps-product__actions">
                                    ...
                                    <li>
                                        <a href="<?php echo $path.$item->url_product ?>" data-toggle="tooltip" data-placement="top" title="Ver producto">
                                            <i class="icon-eye"></i>
                                        </a>
                                    </li>
                                    ...
                                    ?>
                                    <li>
                                        <a class="btn" onclick="addWishlist('<?php echo $item->url_product ?>','<?php echo CurlController::api() ?>','<?php echo $id ?>','<?php echo $_SERVER["REQUEST_URI"] ?>', '<?php echo $path; ?>')" data-toggle="tooltip" data-placement="top" title="Añadir a la lista">
                            ...
                            <div class="ps-product__container">
                                ...
                                <a class="ps-product__vendor" href="<?php echo $path.$item->url_brand ?>"><?php echo $item->name_brand ?></a>
                    ...
                    <div class="ps-product ps-product--wide">
                        ...
                        <div class="ps-product__container">
                            ...
                            <div class="ps-product__shopping">
                                ...
                                onclick="addShoppingCart('<?php echo $item->url_product ?>','<?php echo CurlController::api() ?>', '<?php echo $_SERVER["REQUEST_URI"] ?>', this)"
                                detailsSC
                                quantitySC>Añadir al carrito</a>

                                <ul class="ps-product__actions">
                                    <li><a href="<?php echo $path.$item->url_product ?>"><i class="icon-eye"></i>Ver</a></li>
                                    <li><a class="btn" onclick="addWishlist('<?php echo $item->url_product ?>','<?php echo CurlController::api() ?>','<?php echo $id ?>','<?php echo $_SERVER["REQUEST_URI"] ?>', '<?php echo $path; ?>')"><i class="icon-heart"></i> Lista de deseos</a></li>
                                </ul>
