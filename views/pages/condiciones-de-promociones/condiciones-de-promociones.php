<?php
	...
	$url = CurlController::api()."pageviews?linkTo=type_pageview&equalTo=condiciones-de-promociones&select=".$select;
	$method = "GET";
	$fields = array();
	$header = array();
...
<div class="ps-breadcrumb">
    ...
    <div class="container">
        ...
        <ul class="breadcrumb">
            ...
            <li>Condiciones De Promociones</li>
    ...
    <section class="ps-store-list">
        ...
        <div class="container">
            ...
            <div class="ps-section__header mt-18">
                ...
                <h3 class="mt-35">Condiciones De Promociones</h3>
